...
- (void)configBottomToolBar {
    ...
    if (_tzImagePickerVc.allowPickingOriginalPhoto) {
        ...
        _originalPhotoButton.titleLabel.font = FONT(13);
        ...
        _originalPhotoLabel.font = FONT(13);
    ...
    _doneButton.titleLabel.font = FONT(13);
...
- (void)configCollectionView {
    ...
    _collectionView.contentSize = CGSizeMake(self.models.count * (self.view.tz_width + 20*SCREEN_SCALE), 0);
...
- (void)configCropView {
    ...
    if (_tzImagePickerVc.maxImagesCount <= 1 && _tzImagePickerVc.allowCrop && _tzImagePickerVc.allowPickingImage) {
        ...
        _cropView.layer.borderWidth = 1.0*SCREEN_SCALE;
...
- (void)viewDidLayoutSubviews {
    ...
    _collectionView.frame = CGRectMake(-10*SCREEN_SCALE, 0, self.view.tz_width + 20, self.view.tz_height);
    ...
    CGFloat toolBarHeight = [TZCommonTools tz_isIPhoneX] ? 44*SCREEN_SCALE + (83 - 49)*SCREEN_SCALE : 44*SCREEN_SCALE;
    ...
    if (_tzImagePickerVc.allowPickingOriginalPhoto) {
        ...
        _originalPhotoButton.frame = CGRectMake(0, 0, fullImageWidth + 56*SCREEN_SCALE, 44*SCREEN_SCALE);
        _originalPhotoLabel.frame = CGRectMake(fullImageWidth + 42*SCREEN_SCALE, 0, 80*SCREEN_SCALE, 44*SCREEN_SCALE);
    }
    [_doneButton sizeToFit];
    _doneButton.frame = CGRectMake(self.view.tz_width - _doneButton.tz_width - 12*SCREEN_SCALE, 0, _doneButton.tz_width, 44*SCREEN_SCALE);
    _numberImageView.frame = CGRectMake(_doneButton.tz_left - 24*SCREEN_SCALE - 5*SCREEN_SCALE, 10*SCREEN_SCALE, 24*SCREEN_SCALE, 24*SCREEN_SCALE);
