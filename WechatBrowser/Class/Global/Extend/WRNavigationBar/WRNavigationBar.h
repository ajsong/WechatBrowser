...
/** set default shadowImage color of UINavigationBar */
...
/** record current ViewController navigationBar shadowImage color */
- (void)wr_setNavBarShadowImageColor:(UIColor *)color;
- (UIColor *)wr_navBarShadowImageColor;

/** record current ViewController navigationBar translationY */
- (void)wr_setTranslationY:(CGFloat)translationY;
