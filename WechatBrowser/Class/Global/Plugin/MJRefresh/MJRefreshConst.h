...
// 文字颜色
#define MJRefreshsLabelTextColor MJColor(150, 150, 150)

// 背景颜色
#define MJRefreshsBackGroundColor MJColor(226, 231, 237)

// 控件TAG
#define MJRefreshViewTag 1284631

extern const CGFloat MJRefreshViewHeight;
extern const CGFloat MJRefreshsFastAnimationDuration;
extern const CGFloat MJRefreshsSlowAnimationDuration;
