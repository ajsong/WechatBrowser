...
+ (UIBezierPath *)bezierPathWithCovertedString:(NSString *)string attrinbutes:(NSDictionary *)attributes{
    ...
    //解析字形
    CTLineRef line = CTLineCreateWithAttributedString((__bridge CFAttributedStringRef)attritutedString);
    ...
    [bezierPath appendPath:[UIBezierPath bezierPathWithCGPath:letters]];
    //释放C对象
...
- (NSMutableArray<UIBezierPath *> *)subpath{
